...
import AssetTypePage from "./pages/admin/asset-type/asset-type";
...
import PositionPage from './pages/admin/position/position';
import EmployeePage from './pages/admin/employee/employee';
import CustomerPage from './pages/admin/customer/customer';
import DeviceTypePage from './pages/admin/devicetype/device-type';
import SkillPage from "@/pages/admin/skill/skill";
import SolutionPage from "./pages/admin/solution/solution";
import WarehousePage from "@/pages/admin/warehouse/warehouse";
import UnitPage from "@/pages/admin/unit/unit";
import RejectReasonPage from "@/pages/admin/reject-reason/reject-reason";
import TechnicianSupplierPage from './pages/admin/technician-supplier/technician-supplier';
import IssuePage from "./pages/admin/issue/issue";
import MaterialSupplierPage from "@/pages/admin/material-supplier/material-supplier";
import TechnicianPage from "./pages/admin/technician/technician";
import InventoryItemPage from "./pages/admin/inventory-item/inventory-item";
import DevicePage from "@/pages/admin/device/device";
import ShiftTemplatePage from "@/pages/admin/shift-template/shift-template";
import TechnicianAvailabilityPage from "@/pages/admin/technician-availability/technician-availability";
...
import CustomerPurchaseHistoryPage from "./pages/admin/customer/customer-purchase-history";
...
import MaintenanceCausePage from './pages/admin/maintenance-cause/maintenance-cause';
