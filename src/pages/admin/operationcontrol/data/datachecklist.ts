// datachecklist.ts - Mystery Shopper Checklist Data for Yoshinoya
...
export interface CriticalFailureCase {
  id: string;
  title: string;
  description: string;
}
...
export const checklistDataSource: ChecklistItem[] = [
  // ==========================================
...
// Hướng dẫn chấm điểm
// ==========================================
export const scoringGuidelines: ScoringGuidelines = {
  instructions: [
...
// ==========================================
export const criticalFailureCases: CriticalFailureCase[] = [
  {
    id: 'TH1',
    title: 'Trường hợp 1',
