...
import { useMaterialSupplierByIdQuery } from "@/hooks/useMaterialSuppliers";
...
const ViewMaterialSupplier = ({ onClose, open, supplierId }: IProps) => {
    const { data: supplier, isLoading, isError } = useMaterialSupplierByIdQuery(supplierId || undefined);
    ...
    return (
        ...
        >
            {isLoading ? (
                ...
                <Empty description="Không tìm thấy thông tin nhà cung cấp" />
            ) : (
                <>
                    <Descriptions
                        bordered
...
export default ViewMaterialSupplier;
