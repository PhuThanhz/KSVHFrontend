import { Drawer, Descriptions, Divider, Tag, Table, Image } from "antd";
            ...
            {data && (
                <>
                    ...
                    <Descriptions bordered size="middle" column={2}>
                        ...
                        <Descriptions.Item label="Công suất / Năng lượng">
                            {data.powerCapacity || "-"}
                        </Descriptions.Item>
                        <Descriptions.Item label="Đơn giá">
                            {renderMoney(data.unitPrice)}
                        </Descriptions.Item>
                    ...
                    <Descriptions bordered size="middle" column={2}>
                        ...
                        <Descriptions.Item label="Ngày hết hạn bảo hành">
                            {renderDate(data.warrantyExpiryDate)}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item label="Ngày hết khấu hao dự kiến">
                            {renderDate(data.depreciationEndDate)}
                        </Descriptions.Item>
                        ...
                        <Descriptions.Item label="Chi tiết bảo dưỡng">
                            {data.maintenanceDayOfMonth
                                ...
                                : data.maintenanceDayOfWeek
                                    ? `Thứ ${data.maintenanceDayOfWeek}${data.maintenanceWeekOrder
                                        ? ` - tuần ${data.maintenanceWeekOrder}`
                                        : ""
                                    }`
                    ...
                    <div style={{ whiteSpace: "pre-line", padding: "8px 12px", border: "1px solid #f0f0f0", borderRadius: 6 }}>
